...
export const Aria: Store = {
  ...
  linksBuilder: {
    ...
    urls: [
      ...
      {
        series: '3070ti',
        url: 'https://www.aria.co.uk/Products/Components/Graphics+Cards/NVIDIA+GeForce/GeForce+RTX+3070+Ti',
      },
      {
        series: '3080ti',
        url: 'https://www.aria.co.uk/Products/Components/Graphics+Cards/NVIDIA+GeForce/GeForce+RTX+3080+Ti',
      },
    ],
  },
  name: 'aria',
