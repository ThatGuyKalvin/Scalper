...
export const Scan: Store = {
  ...
  linksBuilder: {
    ...
    urls: [
      ...
      {
        series: '3070ti',
        url: 'https://www.scan.co.uk/shop/gaming/gpu-nvidia-gaming/geforce-rtx-3070-ti-graphics-cards',
      },
      {
        series: '3080ti',
        url: 'https://www.scan.co.uk/shop/gaming/gpu-nvidia-gaming/geforce-rtx-3080-ti-graphics-cards',
      },
    ],
  },
  name: 'scan',
