...
export const AmazonUk: Store = {
  ...
  captchaDeterrent: {
    hardLinks: [
      ...
      'https://www.amazon.co.uk/deals?ref_=nav_cs_td_lm_dt_cr_518676edeef54459ac29a170e34c12b0',
      'https://www.amazon.co.uk/gp/bestsellers/?ref_=nav_em_cs_bestsellers_0_1_1_2',
    ],
    searchTerms: ['chess', 'dungeons+and+dragons'],
    searchUrl: 'https://www.amazon.co.uk/deals?ref_=nav_cs_td_lm_dt_cr_',
  },
  currency: '£',
  labels: {
    captcha: {
    ...
    usedStock: {
      container: '#usedBuySection .a-text-bold',
      text: ['Buy used: '],
    },
    maxPrice: {
      container: '.apexPriceToPay .a-offscreen',
    },
    outOfStock: [
      {
        container: '#availability',
  ...
  links: [
    ...
    },
    {
      brand: 'gigabyte',
      cartUrl:
        'https://www.amazon.co.uk/gp/aws/cart/add.html?ASIN.1=B095X6RLJW&Quantity.1=1',
      model: 'gaming oc',
      series: '3070ti',
      url: 'https://smile.amazon.co.uk/dp/B095X6RLJW',
    },
    {
      brand: 'zotac',
      cartUrl:
        'https://www.amazon.co.uk/gp/aws/cart/add.html?ASIN.1=B09832YFZF&Quantity.1=1',
      model: 'trinity oc',
      series: '3070ti',
      url: 'https://smile.amazon.co.uk/dp/B09832YFZF',
    },
    {
      brand: 'evga',
      cartUrl:
        'https://www.amazon.co.uk/gp/aws/cart/add.html?ASIN.1=B096BHK531&Quantity.1=1',
      model: 'xc3 ultra',
      series: '3070ti',
      url: 'https://smile.amazon.co.uk/dp/B096BHK531',
    },
    {
      brand: 'evga',
      cartUrl:
        'https://www.amazon.co.uk/gp/aws/cart/add.html?ASIN.1=B096BJPGDR&Quantity.1=1',
      model: 'xc3',
      series: '3070ti',
      url: 'https://smile.amazon.co.uk/dp/B096BJPGDR',
    },
    {
      brand: 'gigabyte',
      cartUrl:
        'https://www.amazon.co.uk/gp/aws/cart/add.html?ASIN.1=B095X5QHK5&Quantity.1=1',
      model: 'aorus master',
      series: '3070ti',
      url: 'https://smile.amazon.co.uk/dp/B095X5QHK5',
    },
    {
      brand: 'msi',
      cartUrl:
        'https://www.amazon.co.uk/gp/aws/cart/add.html?ASIN.1=B0957V23FM&Quantity.1=1',
      model: 'gaming x trio',
      series: '3070ti',
      url: 'https://smile.amazon.co.uk/dp/B0957V23FM',
    },
    {
      brand: 'msi',
      cartUrl:
        'https://www.amazon.co.uk/gp/aws/cart/add.html?ASIN.1=B0957TPT1Y&Quantity.1=1',
      model: 'suprim',
      series: '3070ti',
      url: 'https://smile.amazon.co.uk/dp/B0957TPT1Y',
    },
    {
      brand: 'asus',
      cartUrl:
        'https://www.amazon.co.uk/gp/aws/cart/add.html?ASIN.1=B096SF185K&Quantity.1=1',
      model: 'strix',
      series: '3070ti',
      url: 'https://smile.amazon.co.uk/dp/B096SF185K',
    },
    {
      brand: 'gigabyte',
      cartUrl:
        'https://www.amazon.co.uk/gp/aws/cart/add.html?ASIN.1=B095X7XXQK&Quantity.1=1',
      model: 'vision oc',
      series: '3070ti',
      url: 'https://smile.amazon.co.uk/dp/B095X7XXQK',
    },
    {
      brand: 'asus',
      cartUrl:
